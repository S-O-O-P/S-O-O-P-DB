...
(4, '세종 수목원 전시, 함께 가요!', '안녕하세요, 예술을 사랑하는 친구들! 국립세종도서관에서 열리는 <넌 어느 별에서 왔니?> 전시를 함께 보러 갈까요? 다양한 예술 작품들이 우리를 기다리고 있어요. 다 같이 예술의 세계로 떠나보아요!', 3, 'http://www.culture.go.kr/upload/rdf/24/04/show_2024041517101400713.jpg', '세종', 2, '2024-07-15', '2024-07-19', '2024-07-18', '활성화', '모집중', 1, 273946),
