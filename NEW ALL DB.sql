...
VALUES
       ('서비스', '대상혁이 있나요', '대상혁 신전가면 대상혁도 있나요?', 2, '2024-06-03', 1, '답변대기', null, null),
       ('서비스', '중상혁이 있나요', '중상혁 신전가면 중상혁도 있나요?', 3, '2024-06-04', 1, '답변대기', null, null),
       ('서비스', '소상혁이 있나요', '소상혁 신전가면 소상혁도 있나요?', 4, '2024-06-05', 1, '답변대기', null, null),
       ('기능', '허니팟에선 꿀도 주나요', '어디 양봉장 꿀을 주시나요?', 2, '2024-06-03', 1, '답변대기', null, null),
       ('기능', '채찍피티가 뭔가요', '채찍을 맞으면서 피티를 받는 곳인가요?', 3, '2024-06-04', 1, '답변대기', null, null);
