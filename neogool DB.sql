...
VALUES
       ...
       ('이병건', 'chimhaha@emalnyun.com', '남', 'https://i.ibb.co/BqqgBBp/image.jpg', '안녕하세요. 이병건입니다.', 'USER', '2024-06-09', '구글'),
       ('양세찬', 'ung-efather@cobik.com', '남', 'https://i.ibb.co/Yk4jBmw/image.jpg', '안녕하세요. 양세찬입니다.', 'USER', '2024-06-10', '카카오'),
...
INSERT
 ...
 VALUES
(1,	'이어도 이어도',  '끝이없지요', 8, 'http://www.culture.go.kr/upload/rdf/24/06/rdf_2024060121182112365.gif', '경기', 4,	'2024-07-02', '2024-07-12',	'2024-07-11', '활성화', '모집중', null, 278653),
(4,	'무민 보러가실분',	'귀여운 무민 다같이 보러가요 호호호', 9, 'http://www.culture.go.kr/upload/rdf/24/07/show_202407114292523469.jpg', '경기', 3,	'2024-07-03','2024-07-18','2024-07-17',	'활성화',	'모집중',	0, 281584),
(4,	'인투 디 언론', '언론의 지평선 함께 보실 분 모집합니다.', 10, 'http://www.culture.go.kr/upload/rdf/24/06/show_202406211646751928.jpg', '서울', 3, '2024-07-03','2024-07-16','2024-07-15',	'활성화',	'모집중',	0, 280493),
(4,	'마지막 잎새 함께 보실분', '마지막 잎새 보러가실분 구합니다 목포항항항',	 11,	'http://www.culture.go.kr/upload/rdf/24/07/show_202407011323004301.png', '전남', 2, '2024-07-03', '2024-07-18', '2024-07-17', '활성화', '모집중', 0, 281594),
(2, '울림 보러 가실분', '클라리넷 앙상블 최고에용', 8, 'http://www.culture.go.kr/upload/rdf/24/06/rdf_2024060121193007389.jpg', '서울', 4,	'2024-07-03', '2024-07-10',	'2024-07-09', '활성화', '모집중', 0, 278654),
(2, '이영주 피아노 독주회 가실분', '페루치오 부소니가 서거한지 100년이나 지났다고!?', 8, 'http://www.culture.go.kr/upload/rdf/24/06/rdf_2024060721473216437.png',	'서울', 2, '2024-07-03', '2024-07-09', '2024-07-08', '활성화', '모집중',	0, 279065),
(4, '동굴은 무대다', '동굴은 무대다!!!!!!', 9, 'http://www.culture.go.kr/upload/rdf/24/07/show_202407114132945603.jpg', '서울',	4, '2024-07-03', '2024-07-16', '2024-07-15', '활성화', '모집중', 0, 281597),
(4, '낭만은 죽었다', '냥 만 남았을 뿐', 10, 'http://www.culture.go.kr/upload/rdf/24/06/show_202406281515008173.jpg', '서울',	4, '2024-07-03', '2024-07-18', '2024-07-17', '활성화', '모집중', 0,	281292),
(2, '목관 5중주 목음 창단 연주회', '목관 5중주 목음 창단 연주회 재밌겠져?', 11, 'http://www.culture.go.kr/upload/rdf/24/06/rdf_2024061921182613285.gif', '서울',	2, '2024-07-03', '2024-07-15', '2024-07-14', '활성화', '모집중', 0,	280396),
(2, '청년 브람스 보러가여', '든든한 방패인 브라움아닙니다.',	 8, 'http://www.culture.go.kr/upload/rdf/24/06/rdf_2024062421182010762.gif', '서울',	2, '2024-07-03', '2024-07-08', '2024-07-07', '활성화', '모집중', 0,	280990),
(5, '심산영화관 같이 가요', '토렌트로 받았습니다.', 9, 'http://www.culture.go.kr/upload/rdf/24/05/show_2024051010195219500.jpg', '서울', 3, '2024-07-03', '2024-07-10', '2024-07-09', '활성화', '모집중', 0, 276416),
(4, '같이 보러가요', '감자를 드려요', 10, 'http://www.culture.go.kr/upload/rdf/24/07/show_202407217562437108.jpg', '강원', 2, '2024-07-03', '2024-07-12', '2024-07-11', '활성화', '모집중', 0, 281687);
-- 참가신청 DB
INSERT
  INTO
...
VALUES
	  (1, 9, '몇시에 모여요?', '2024-06-01 09:00:00', null),
      (1, 8, '구마유시에 모입니다. 껄껄', '2024-06-01 09:05:00', null),
      (2, 9, '저희 모임은 오후 5시 30분에 진행합니다.', '2024-06-08 09:00:00', null),
      (2, 10, '넵', '2024-06-09 10:00:01', null);
